...
from pupillab_input import EyeCoordinateGenerator, EyeGenConfig #added by Amber, eye tracker input
...
from eye_hybrid_decoder import EyeHybridDecoderNode, EyeHybridDecoderConfig #added by Amber, eye tracker deocder (i.e. mouse cursor)
...
class EyeEmgHybridTaskGraph(lg.Graph):
    ...
    EyeStreamNode: EyeCoordinateGenerator # generates eye tracker cursor
    DecoderNode: HybridDecoderNode # EMG decoder
    EyeDecoderNode: EyeHybridDecoderNode #eye tracker decoder (simply return xy coordinates)
    ...
    def setup(self) -> None:
        ...
        self.EyeDecoderNode.configure(
            EyeHybridDecoderConfig(
    ...
    def connections(self) -> lg.Connections:
        return(
            ...
            (self.EyeStreamNode.OUTPUT, self.EyeDecoderNode.SENSOR_INPUT), # Eye Input to Eye Decoder
            ...
            (self.EyeDecoderNode.CONTROL_OUTPUT, self.GraphicsNodeTracking.CURSOR_INPUT2) # Eye Decoder Output to Graphics (i.e. display mouse cursor)
        )
